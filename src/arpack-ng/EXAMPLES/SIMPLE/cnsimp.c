/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\SIMPLE\cnsimp.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    integer iparam[11];
    extern int cnaupd_(integer *, char *, integer *, char *, integer *, real *, complex *, integer *, complex *, integer *, integer *, integer *, complex *, complex *, integer *, real *, integer *, ftnlen, ftnlen);
    logical select[30];
    extern int cneupd_(logical *, char *, logical *, complex *, complex *, integer *, complex *, complex *, char *, integer *, char *, integer *, real *, complex *, integer *, complex *, integer *, integer *, integer *, complex *, complex *, integer *, real *, integer *, ftnlen, ftnlen, ftnlen);
...
int av_(integer *nx, complex *v, complex *w)
{
    ...
    complex h2;
    integer lo;
    extern int tv_(integer *, complex *, complex *), caxpy_(integer *, complex *, complex *, integer *, complex *, integer *);
...
/* Main program alias */ int cnsimp_()
{
    MAIN__();
    return 0;
}
