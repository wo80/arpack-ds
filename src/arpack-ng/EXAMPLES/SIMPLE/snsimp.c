/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\SIMPLE\snsimp.f -- translated by f2c (version 20230428).
...
int av_(integer *nx, real *v, real *w)
{
    ...
    real h2;
    integer lo;
    extern int tv_(integer *, real *, real *), saxpy_(integer *, real *, real *, integer *, real *, integer *);
...
/* Main program alias */ int snsimp_()
{
    MAIN__();
    return 0;
}
