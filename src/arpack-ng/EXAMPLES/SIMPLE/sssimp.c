/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\SIMPLE\sssimp.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    extern int ssaupd_(integer *, char *, integer *, char *, integer *, real *, real *, integer *, real *, integer *, integer *, integer *, real *, real *, integer *, integer *, ftnlen, ftnlen), sseupd_(logical *, char *, logical *, real *, real *, integer *, real *, char *, integer *, char *, integer *, real *, real *, integer *, real *, integer *, integer *, integer *, real *, real *, integer *, integer *, ftnlen, ftnlen, ftnlen);
    integer lworkl;
...
int av_(integer *nx, real *v, real *w)
{
    ...
    real h2;
    integer n2, lo;
    extern int tv_(integer *, real *, real *), sscal_(integer *, real *, real *, integer *), saxpy_(integer *, real *, real *, integer *, real *, integer *);
...
/* Main program alias */ int sssimp_()
{
    MAIN__();
    return 0;
}
