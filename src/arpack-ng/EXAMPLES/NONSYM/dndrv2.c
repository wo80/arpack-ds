/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\NONSYM\dndrv2.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    integer j, n;
    doublereal s, v[6400] /* was [256][25] */, s1, s2, s3, dd[256], dl[256];
    ...
    doublereal sigmar;
    extern int dgttrf_(integer *, doublereal *, doublereal *, doublereal *, doublereal *, integer *, integer *);
...
/* Main program alias */ int dndrv2_()
{
    MAIN__();
    return 0;
}
