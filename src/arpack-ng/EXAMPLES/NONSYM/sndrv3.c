/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\NONSYM\sndrv3.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    real workev[75];
    extern int spttrf_(integer *, real *, real *, integer *), spttrs_(integer *, integer *, real *, real *, real *, integer *, integer *);
...
/* Main program alias */ int sndrv3_()
{
    MAIN__();
    return 0;
}
