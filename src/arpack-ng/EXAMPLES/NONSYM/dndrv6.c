/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\NONSYM\dndrv6.f -- translated by f2c (version 20230428).
...
L20:
    ...
    if (ido == -1)
    {
        ...
        zgttrs_("N", &n, &c__1, cdl, cdd, cdu, cdu2, ipiv, ctemp, &c__256, &ierr, (ftnlen)1);
        if (ierr != 0)
        {
            s_wsle(&io___38);
            do_lio(&c__9, &c__1, " ", (ftnlen)1);
...
/* Main program alias */ int dndrv6_()
{
    MAIN__();
    return 0;
}
