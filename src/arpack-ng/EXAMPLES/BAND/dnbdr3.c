/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\dnbdr3.f -- translated by f2c (version 20230428).
...
/*     %-------------------------------------% */
	...
	m[isup + (j + 1) * 50 - 51] = h__ * 1.;
	m[isub + j * 50 - 51] = h__ * 1.;
/* L50: */
    }
...
/* Main program alias */ int dnbdr3_ () { MAIN__ (); return 0; }
