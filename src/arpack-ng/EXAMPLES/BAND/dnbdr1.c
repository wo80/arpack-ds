/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\dnbdr1.f -- translated by f2c (version 20230428).
...
/*     %-------------------------------------% */
	...
	i__2 = lo + nx - 1;
	for (j = lo + 1; j <= i__2; ++j) {
	    a[isup + (j + 1) * 50 - 51] = -1. / h2 + rho / 2. / h__;
	    a[isub + j * 50 - 51] = -1. / h2 - rho / 2. / h__;
/* L40: */
	}
/* L50: */
    }
...
/* Main program alias */ int dnbdr1_ () { MAIN__ (); return 0; }
