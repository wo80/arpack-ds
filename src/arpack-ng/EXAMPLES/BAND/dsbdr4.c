/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\dsbdr4.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    integer n;
    doublereal v[50000]	/* was [1000][50] */, r1, r2;
    integer kl;
    doublereal ax[1000];
    integer ku;
    doublereal mx[1000];
    ...
    extern /* Subroutine */ int dsband_(logical *, char *, logical *, 
...
/*     %-------------------------------------% */
    ...
    rvec = TRUE_;
    dsband_(&rvec, "A", select, d__, v, &c__1000, &sigma, &n, a, m, &c__50, 
...
/*        %----------------------------% */
	...
	i__1 = nconv;
	for (j = 1; j <= i__1; ++j) {
	    dgbmv_("Notranspose", &n, &n, &kl, &ku, &c_b97, &a[kl], &c__50, &
		    v[j * 1000 - 1000], &c__1, &c_b15, ax, &c__1, (ftnlen)11);
	    dgbmv_("Notranspose", &n, &n, &kl, &ku, &c_b97, &m[kl], &c__50, &
...
/* L90: */
	...
	dmout_(&c__6, &nconv, &c__2, d__, &c__50, &c_n6, "Ritz values and re"
...
/* Main program alias */ int dsbdr4_ () { MAIN__ (); return 0; }
