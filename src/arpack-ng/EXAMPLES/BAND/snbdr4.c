/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\snbdr4.f -- translated by f2c (version 20230428).
...
/*     %-------------------------------------% */
	...
	m[isup + (j + 1) * 50 - 51] = h__ * 1.f / 6.f;
	m[isub + j * 50 - 51] = h__ * 1.f / 6.f;
/* L40: */
    }
...
/*              %--------------------% */
		...
		sgbmv_("Notranspose", &n, &n, &kl, &ku, &c_b97, &a[kl], &
			c__50, &v[j * 1000 - 1000], &c__1, &c_b15, ax, &c__1, 
			(ftnlen)11);
		sgbmv_("Notranspose", &n, &n, &kl, &ku, &c_b97, &m[kl], &
...
/* Main program alias */ int snbdr4_ () { MAIN__ (); return 0; }
