...
/* Subroutine */ int cnband_(logical *rvec, char *howmny, logical *select, 
	complex *d__, complex *z__, integer *ldz, complex *sigma, complex *
	workev, integer *n, complex *ab, complex *mb, integer *lda, complex *
	fac, integer *kl, integer *ku, char *which, char *bmat, integer *nev, 
	real *tol, complex *resid, integer *ncv, complex *v, integer *ldv, 
	integer *iparam, complex *workd, complex *workl, integer *lworkl, 
	real *rwork, integer *iwork, integer *info, ftnlen howmny_len, ftnlen 
	which_len, ftnlen bmat_len)
{
    ...
    extern /* Subroutine */ int cgbtrf_(integer *, integer *, integer *, 
	    integer *, complex *, integer *, integer *, integer *), cnaupd_(
	    integer *, char *, integer *, char *, integer *, real *, complex *
	    , integer *, complex *, integer *, integer *, integer *, complex *
	    , complex *, integer *, real *, integer *, ftnlen, ftnlen), 
	    clacpy_(char *, integer *, integer *, complex *, integer *, 
	    complex *, integer *, ftnlen), cneupd_(logical *, char *, logical 
	    *, complex *, complex *, integer *, complex *, complex *, char *, 
	    ...
	    integer *, real *, integer *, ftnlen, ftnlen, ftnlen), cgbtrs_(
...
/*            %-------------------------% */
		...
		i__3 = imid + j * ab_dim1;
		q__1.r = ab[i__3].r - sigma->r, q__1.i = ab[i__3].i - 
			sigma->i;
...
/*            %---------------------------% */
		...
		for (i__ = itop; i__ <= i__2; ++i__) {
		    ...
		    i__4 = i__ + j * ab_dim1;
		    i__5 = i__ + j * mb_dim1;
		    q__2.r = sigma->r * mb[i__5].r - sigma->i * mb[i__5].i, 
			    q__2.i = sigma->r * mb[i__5].i + sigma->i * mb[
			    i__5].r;
		    q__1.r = ab[i__4].r - q__2.r, q__1.i = ab[i__4].i - 
			    q__2.i;
...
L40:
    ...
    cnaupd_(&ido, bmat, n, which, nev, tol, &resid[1], ncv, &v[v_offset], ldv,
...
/*           %----------------------------% */
	    ...
	    cgbmv_("Notranspose", n, n, kl, ku, &c_b1, &ab[itop + ab_dim1], 
...
/*           %-----------------------------------% */
	    ...
	    cgbtrs_("Notranspose", n, kl, ku, &c__1, &fac[fac_offset], lda, &
...
/*           %-----------------------------------------% */
	    ...
	    cgbmv_("Notranspose", n, n, kl, ku, &c_b1, &mb[itop + mb_dim1], 
		    lda, &workd[ipntr[0]], &c__1, &c_b2, &workd[ipntr[1]], &
		    c__1, (ftnlen)11);
...
/*              %----------------------------------% */
		...
		cgbtrs_("Notranspose", n, kl, ku, &c__1, &fac[fac_offset], 
...
/*        %--------------------% */
	...
	cgbmv_("Notranspose", n, n, kl, ku, &c_b1, &mb[itop + mb_dim1], lda, &
...
/*           %--------------------------% */
	    ...
	    cneupd_(rvec, howmny, &select[1], &d__[1], &z__[z_offset], ldz, 
