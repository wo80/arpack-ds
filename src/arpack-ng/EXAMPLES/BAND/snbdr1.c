/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\snbdr1.f -- translated by f2c (version 20230428).
...
/*     %-------------------------------------% */
	...
	i__2 = lo + nx - 1;
	for (j = lo + 1; j <= i__2; ++j) {
	    a[isup + (j + 1) * 50 - 51] = -1.f / h2 + rho / 2.f / h__;
	    a[isub + j * 50 - 51] = -1.f / h2 - rho / 2.f / h__;
/* L40: */
	}
/* L50: */
    }
...
/* Main program alias */ int snbdr1_ () { MAIN__ (); return 0; }
