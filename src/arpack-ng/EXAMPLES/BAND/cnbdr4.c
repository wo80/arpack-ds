/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\cnbdr4.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    extern doublereal scnrm2_(integer *, complex *, integer *), slapy2_(real *
	    , real *);
    extern /* Subroutine */ int cnband_(logical *, char *, logical *, complex 
...
/*     %---------------% */
	...
	i__2 = idiag + j * 50 - 51;
	q__2.r = h__.r * 4.f - h__.i * 0.f, q__2.i = h__.i * 4.f + h__.r * 
		0.f;
...
/*     %-------------------------------------% */
	...
	a[i__2].r = q__1.r, a[i__2].i = q__1.i;
	i__2 = isup + (j + 1) * 50 - 51;
	q__2.r = h__.r * 1.f - h__.i * 0.f, q__2.i = h__.i * 1.f + h__.r * 
		0.f;
	c_div(&q__1, &q__2, &c_b5);
	m[i__2].r = q__1.r, m[i__2].i = q__1.i;
	i__2 = isub + j * 50 - 51;
...
/*     %-----------------------------------------------% */
    ...
    rvec = TRUE_;
    cnband_(&rvec, "A", select, d__, v, &c__1000, &sigma, workev, &n, a, m, &
...
/*           %----------------------------% */
	    ...
	    cgbmv_("Notranspose", &n, &n, &kl, &ku, &c_b1, &a[kl], &c__50, &v[
		    j * 1000 - 1000], &c__1, &c_b2, ax, &c__1, (ftnlen)11);
	    cgbmv_("Notranspose", &n, &n, &kl, &ku, &c_b1, &m[kl], &c__50, &v[
...
/* L90: */
	...
	smout_(&c__6, &nconv, &c__3, rd, &c__50, &c_n6, "Ritz values (Real,I"
