/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\dsbdr1.f -- translated by f2c (version 20230428).
...
/*        %----------------------------% */
	...
	i__1 = nconv;
	for (j = 1; j <= i__1; ++j) {
	    dgbmv_("Notranspose", &n, &n, &kl, &ku, &c_b100, &a[kl], &c__50, &
...
/* Main program alias */ int dsbdr1_ () { MAIN__ (); return 0; }
