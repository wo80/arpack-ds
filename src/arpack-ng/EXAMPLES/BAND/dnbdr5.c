/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\dnbdr5.f -- translated by f2c (version 20230428).
...
/* Main program alias */ int dnbdr5_ () { MAIN__ (); return 0; }
