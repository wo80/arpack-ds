/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\BAND\znbdr2.f -- translated by f2c (version 20230428).
...
static doublecomplex c_b26 = {4.,0.};
...
/* Main program */ int MAIN__(void)
{
    ...
    integer n;
    doublecomplex v[50000]	/* was [1000][50] */, h2;
    doublereal rd[150]	/* was [50][3] */;
    integer kl;
    doublecomplex ax[1000];
    integer lo, ku;
    doublecomplex fac[50000]	/* was [50][1000] */;
    integer ncv, nev;
    doublecomplex rho;
    integer nxi;
    doublereal tol;
...
/*     %-------------------------------------------------% */
    ...
    if (n > 1000) {
	s_wsle(&io___5);
	do_lio(&c__9, &c__1, " ERROR with _NBDR2: N is greater than MAXN ", (
		ftnlen)43);
	e_wsle();
	goto L9000;
    } else if (nev > 25) {
	s_wsle(&io___6);
	do_lio(&c__9, &c__1, " ERROR with _NBDR2: NEV is greater than MAXNEV "
		, (ftnlen)47);
	e_wsle();
	goto L9000;
    } else if (ncv > 50) {
	s_wsle(&io___7);
	do_lio(&c__9, &c__1, " ERROR with _NBDR2: NCV is greater than MAXNCV "
		, (ftnlen)47);
	e_wsle();
	goto L9000;
    }
...
/* Main program alias */ int znbdr2_ () { MAIN__ (); return 0; }
