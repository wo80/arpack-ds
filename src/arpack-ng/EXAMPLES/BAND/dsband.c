/* EXAMPLES\BAND\dsband.f -- translated by f2c (version 20230428). */
...
L90:
    ...
    dsaupd_(&ido, bmat, n, which, nev, tol, &resid[1], ncv, &v[v_offset], ldv, &iparam[1], ipntr, &workd[1], &workl[1], lworkl, info, (ftnlen)1, (ftnlen)2);
    ...
    if (ido == -1)
    {
        ...
        if (type__ == 1)
        {
            ...
            dgbmv_("Notranspose", n, n, kl, ku, &c_b50, &ab[itop + ab_dim1], lda, &workd[ipntr[0]], &c__1, &c_b52, &workd[ipntr[1]], &c__1, (ftnlen)11);
        }
        else if (type__ == 2)
        {
        ...
        else if (type__ == 4)
        {
            ...
            dgbmv_("Notranspose", n, n, kl, ku, &c_b50, &mb[itop + mb_dim1], lda, &workd[ipntr[0]], &c__1, &c_b52, &workd[ipntr[1]], &c__1, (ftnlen)11);
            dgbtrs_("Notranspose", n, kl, ku, &c__1, &rfac[rfac_offset], lda, &iwork[1], &workd[ipntr[1]], n, &ierr, (ftnlen)11);
            if (ierr != 0)
            {
                s_wsle(&io___28);
        ...
        else if (type__ == 6)
        {
            ...
            {
                dgbmv_("Notranspose", n, n, kl, ku, &c_b50, &ab[itop + ab_dim1], lda, &workd[ipntr[0]], &c__1, &c_b52, &workd[ipntr[1]], &c__1, (ftnlen)11);
                dgbmv_("Notranspose", n, n, kl, ku, sigma, &mb[itop + mb_dim1], lda, &workd[ipntr[0]], &c__1, &c_b50, &workd[ipntr[1]], &c__1, (ftnlen)11);
            }
            else
            {
                dcopy_(n, &workd[ipntr[0]], &c__1, &workd[ipntr[1]], &c__1);
                dgbmv_("Notranspose", n, n, kl, ku, &c_b50, &ab[itop + ab_dim1], lda, &workd[ipntr[0]], &c__1, sigma, &workd[ipntr[1]], &c__1, (ftnlen)11);
            }
    ...
    else
    {
        ...
        else
        {
            ...
            if (iparam[5] > 0)
            {
                ...
                dseupd_(rvec, "A", &select[1], &d__[1], &z__[z_offset], ldz, sigma, bmat, n, which, nev, tol, &resid[1], ncv, &v[v_offset], ldv, &iparam[1], ipntr, &workd[1], &workl[1], lworkl, info, (ftnlen)1, (ftnlen)1, (ftnlen)2);
