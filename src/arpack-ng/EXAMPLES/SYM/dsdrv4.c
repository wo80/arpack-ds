/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\SYM\dsdrv4.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    extern int av_(integer *, doublereal *, doublereal *), mv_(integer *, doublereal *, doublereal *);
