/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\COMPLEX\zndrv4.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    integer j, n;
    doublecomplex s, v[6400] /* was [256][25] */, s1, s2, s3, dd[256], dl[256];
    ...
    extern int zcopy_(integer *, doublecomplex *, integer *, doublecomplex *, integer *), zaxpy_(integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, integer *);
    ...
    *(unsigned char *)bmat = 'G';
    ...
    z__6.r = sigma.r * h__.r - sigma.i * h__.i, z__6.i = sigma.r * h__.i + sigma.i * h__.r;
    z_div(&z__5, &z__6, &c_b5);
    z__1.r = z__2.r - z__5.r, z__1.i = z__2.i - z__5.i;
    s1.r = z__1.r, s1.i = z__1.i;
    z_div(&z__2, &c_b3, &h__);
    z__5.r = sigma.r * 4. - sigma.i * 0., z__5.i = sigma.i * 4. + sigma.r * 0.;
    z__4.r = z__5.r * h__.r - z__5.i * h__.i, z__4.i = z__5.r * h__.i + z__5.i * h__.r;
