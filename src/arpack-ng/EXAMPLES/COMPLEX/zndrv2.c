/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\COMPLEX\zndrv2.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    integer j, n;
    doublecomplex s, v[6400] /* was [256][25] */, h2, s1, s2, s3, dd[256], dl[256];
...
/* Main program alias */ int zndrv2_()
{
    MAIN__();
    return 0;
}
