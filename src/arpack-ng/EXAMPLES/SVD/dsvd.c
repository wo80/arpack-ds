/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\SVD\dsvd.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    /* Local variables */
    integer j, m, n;
    doublereal s[50] /* was [25][2] */, u[5000] /* was [500][10] */, v[6250] /* was [250][25] */;
    extern int av_(integer *, integer *, doublereal *, doublereal *);
    doublereal ax[500];
    integer ido, ncv, nev;
    extern int atv_(integer *, integer *, doublereal *, doublereal *);
    doublereal tol;
    char bmat[1];
    integer info;
    logical rvec;
...
int atv_(integer *m, integer *n, doublereal *w, doublereal *y)
{
    /* System generated locals */
    integer i__1, i__2;
