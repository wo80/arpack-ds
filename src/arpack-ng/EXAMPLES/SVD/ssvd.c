/* D:\projects\Fortran\arpack-ng-3.9.1-patched\EXAMPLES\SVD\ssvd.f -- translated by f2c (version 20230428).
...
/* Main program */ int MAIN__(void)
{
    ...
    real s[50] /* was [25][2] */, u[5000] /* was [500][10] */, v[6250]
        /* was [250][25] */;
    extern int av_(integer *, integer *, real *, real *);
    real ax[500];
    integer ido, ncv, nev;
    extern int atv_(integer *, integer *, real *, real *);
    real tol;
    char bmat[1];
    integer info;
    logical rvec;
