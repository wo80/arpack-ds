...
void av_(const a_int m, const a_int n, const float *x, float *w);
void atv_(const a_int m, const a_int n, const float *w, float *y);
    ...
    else
    {
        ...
        else
        {
            ...
            for (j = 1; j <= i__1; ++j)
            {
                ...
                scopy_(&m, ax, &i_one, &u[j * 500 - 500], &i_one);
                temp = 1.f / snrm2_(&m, &u[j * 500 - 500], &i_one);
                sscal_(&m, &temp, &u[j * 500 - 500], &i_one);
                ...
                r__1 = -s[j - 1];
                saxpy_(&m, &r__1, &u[j * 500 - 500], &i_one, ax, &i_one);
