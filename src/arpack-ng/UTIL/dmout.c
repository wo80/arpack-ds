/* D:\projects\Fortran\arpack-ng-3.9.1-patched\UTIL\dmout.f -- translated by f2c (version 20230428).
...
int dmout_(integer *lout, integer *m, integer *n, doublereal *a, integer *lda, integer *idigit, char *ifmt, ftnlen ifmt_len)
{
    /* Initialized data */
