/* D:\projects\Fortran\arpack-ng-3.9.1-patched\UTIL\dvout.f -- translated by f2c (version 20230428).
...
int dvout_(integer *lout, integer *n, doublereal *sx, integer *idigit, char *ifmt, ftnlen ifmt_len)
{
    /* Format strings */
