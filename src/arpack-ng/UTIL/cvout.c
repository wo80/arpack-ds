/* D:\projects\Fortran\arpack-ng-3.9.1-patched\UTIL\cvout.f -- translated by f2c (version 20230428).
...
int cvout_(integer *lout, integer *n, complex *cx, integer *idigit, char *ifmt, ftnlen ifmt_len)
{
    /* Format strings */
