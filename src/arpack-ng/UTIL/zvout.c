/* D:\projects\Fortran\arpack-ng-3.9.1-patched\UTIL\zvout.f -- translated by f2c (version 20230428).
...
int zvout_(integer *lout, integer *n, doublecomplex *cx, integer *idigit, char *ifmt, ftnlen ifmt_len)
{
    /* Format strings */
