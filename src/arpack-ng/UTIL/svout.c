/* D:\projects\Fortran\arpack-ng-3.9.1-patched\UTIL\svout.f -- translated by f2c (version 20230428).
...
int svout_(integer *lout, integer *n, real *sx, integer *idigit, char *ifmt, ftnlen ifmt_len)
{
    /* Format strings */
