...
extern "C"
{
    ...
    extern void clahqr_(a_bool*, a_bool*, int*, int*, int*, a_fcomplex*, int*, a_fcomplex*, int*, int*, a_fcomplex*, int*, int*);
    ...
    extern void ctrevc_(char*, char*, a_bool*, int*, a_fcomplex*, int*, a_fcomplex*, int*, a_fcomplex*, int*, int*, int*, a_fcomplex*, float*, int*);
    extern void ctrsen_(char*, char*, a_bool*, int*, a_fcomplex*, int*, a_fcomplex*, int*, a_fcomplex*, int*, float*, float*, a_fcomplex*, int*, int*);
    ...
    extern void dlahqr_(a_bool*, a_bool*, int*, int*, int*, double*, int*, double*, double*, int*, int*, double*, int*, int*);
    ...
    extern void dtrevc_(char*, char*, a_bool*, int*, double*, int*, double*, int*, double*, int*, int*, int*, double*, int*);
    extern void dtrsen_(char*, char*, a_bool*, int*, double*, int*, double*, int*, double*, double*, int*, double*, double*, double*, int*, int*, int*, int*);
    ...
    extern void slahqr_(a_bool*, a_bool*, int*, int*, int*, float*, int*, float*, float*, int*, int*, float*, int*, int*);
    ...
    extern void strevc_(char*, char*, a_bool*, int*, float*, int*, float*, int*, float*, int*, int*, int*, float*, int*);
    extern void strsen_(char*, char*, a_bool*, int*, float*, int*, float*, int*, float*, float*, int*, float*, float*, float*, int*, int*, int*, int*);
    ...
    extern void zlahqr_(a_bool*, a_bool*, int*, int*, int*, a_dcomplex*, int*, a_dcomplex*, int*, int*, a_dcomplex*, int*, int*);
    ...
    extern void ztrevc_(char*, char*, a_bool*, int*, a_dcomplex*, int*, a_dcomplex*, int*, a_dcomplex*, int*, int*, int*, a_dcomplex*, double*, int*);
    extern void ztrsen_(char*, char*, a_bool*, int*, a_dcomplex*, int*, a_dcomplex*, int*, a_dcomplex*, int*, double*, double*, a_dcomplex*, int*, int*);
