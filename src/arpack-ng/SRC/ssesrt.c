/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\ssesrt.f -- translated by f2c (version 20230428).
...
int ssesrt_(char *which, logical *apply, integer *n, real *x, integer *na, real *a, integer *lda, ftnlen which_len)
{
