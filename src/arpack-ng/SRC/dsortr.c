/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\dsortr.f -- translated by f2c (version 20230428).
...
int dsortr_(char *which, logical *apply, integer *n, doublereal *x1, doublereal *x2, ftnlen which_len)
{
