/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\cnapps.f -- translated by f2c (version 20230428).
...
int cnapps_(integer *n, integer *kev, integer *np, complex *shift, complex *v, integer *ldv, complex *h__, integer *ldh, complex *resid, complex *q, integer *ldq, complex *workl, complex *workd)
{
    ...
    claset_("All", &kplusp, &kplusp, &c_b2, &c_b1, &q[q_offset], ldq, (ftnlen)3);
    ...
    for (jj = 1; jj <= i__1; ++jj)
    {
        ...
        if (msglvl > 2)
        {
            ivout_(&debug_1.logfil, &c__1, &jj, &debug_1.ndigit,
                   ...
                   "ift number.",
                   (ftnlen)21);
            cvout_(&debug_1.logfil, &c__1, &sigma, &debug_1.ndigit,
                   "_napps:"
                   " Value of the shift ",
                   (ftnlen)27);
        }
    ...
    L20:
        ...
        for (i__ = istart; i__ <= i__2; ++i__)
        {
            ...
            tst1 = (r__1 = h__[i__3].r, dabs(r__1)) + (r__2 = r_imag(&h__[i__ + i__ * h_dim1]), dabs(r__2)) + ((r__3 = h__[i__4].r, dabs(r__3)) + (r__4 = r_imag(&h__[i__ + 1 + (i__ + 1) * h_dim1]), dabs(r__4)));
            if (tst1 == 0.f)
            {
                i__3 = kplusp - jj + 1;
                tst1 = clanhs_("1", &i__3, &h__[h_offset], ldh, &workl[1], (ftnlen)1);
            }
            ...
            if ((r__1 = h__[i__3].r, dabs(r__1)) <= dmax(r__2, smlnum))
            {
                if (msglvl > 0)
                {
                    ...
                    cvout_(&debug_1.logfil, &c__1, &h__[i__ + 1 + i__ * h_dim1], &debug_1.ndigit,
                           "_napps: off diagonal "
                           "element.",
                           (ftnlen)29);
                }
    ...
    L40:
        ...
        for (i__ = istart; i__ <= i__2; ++i__)
        {
            ...
            for (j = i__; j <= i__3; ++j)
            {
                ...
                i__5 = i__ + 1 + j * h_dim1;
                q__3.r = s.r * h__[i__5].r - s.i * h__[i__5].i, q__3.i = s.r * h__[i__5].i + s.i * h__[i__5].r;
                ...
                i__5 = i__ + j * h_dim1;
                q__2.r = q__3.r * h__[i__5].r - q__3.i * h__[i__5].i, q__2.i = q__3.r * h__[i__5].i + q__3.i * h__[i__5].r;
                i__6 = i__ + 1 + j * h_dim1;
            ...
            for (j = 1; j <= i__3; ++j)
            {
                ...
                r_cnjg(&q__4, &s);
                i__5 = j + (i__ + 1) * h_dim1;
                q__3.r = q__4.r * h__[i__5].r - q__4.i * h__[i__5].i, q__3.i = q__4.r * h__[i__5].i + q__4.i * h__[i__5].r;
                q__1.r = q__2.r + q__3.r, q__1.i = q__2.i + q__3.i;
                t.r = q__1.r, t.i = q__1.i;
                i__4 = j + (i__ + 1) * h_dim1;
    ...
    for (i__ = 1; i__ <= i__1; ++i__)
    {
        ...
        i__2 = i__ + i__ * h_dim1;
        i__3 = i__ + 1 + (i__ + 1) * h_dim1;
        tst1 = (r__1 = h__[i__2].r, dabs(r__1)) + (r__2 = r_imag(&h__[i__ + i__ * h_dim1]), dabs(r__2)) + ((r__3 = h__[i__3].r, dabs(r__3)) + (r__4 = r_imag(&h__[i__ + 1 + (i__ + 1) * h_dim1]), dabs(r__4)));
        if (tst1 == 0.f)
        {
            tst1 = clanhs_("1", kev, &h__[h_offset], ldh, &workl[1], (ftnlen)1);
        }
    ...
    if (h__[i__1].r > 0.f)
    {
        cgemv_("N", n, &kplusp, &c_b1, &v[v_offset], ldv, &q[(*kev + 1) * q_dim1 + 1], &c__1, &c_b2, &workd[*n + 1], &c__1, (ftnlen)1);
    }
    ...
    {
        i__2 = kplusp - i__ + 1;
        cgemv_("N", n, &i__2, &c_b1, &v[v_offset], ldv, &q[(*kev - i__ + 1) * q_dim1 + 1], &c__1, &c_b2, &workd[1], &c__1, (ftnlen)1);
        ccopy_(n, &workd[1], &c__1, &v[(kplusp - i__ + 1) * v_dim1 + 1], &c__1);
        /* L140: */
    }
    ...
    if (h__[i__1].r > 0.f)
    {
        caxpy_(n, &h__[*kev + 1 + *kev * h_dim1], &v[(*kev + 1) * v_dim1 + 1], &c__1, &resid[1], &c__1);
    }

    if (msglvl > 1)
    {
        cvout_(&debug_1.logfil, &c__1, &q[kplusp + *kev * q_dim1], &debug_1.ndigit, "_napps: sigmak = (e_{kev+p}^T*Q)*e_{kev}", (ftnlen)40);
        cvout_(&debug_1.logfil, &c__1, &h__[*kev + 1 + *kev * h_dim1], &debug_1.ndigit, "_napps: betak = e_{kev+1}^T*H*e_{kev}", (ftnlen)37);
        ...
        if (msglvl > 2)
        {
            cmout_(&debug_1.logfil, kev, kev, &h__[h_offset], ldh, &debug_1.ndigit,
