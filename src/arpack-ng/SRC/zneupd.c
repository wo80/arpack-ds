/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\zneupd.f -- translated by f2c (version 20230428).
...
int zneupd_(logical *rvec, char *howmny, logical *select, doublecomplex *d__, doublecomplex *z__, integer *ldz, doublecomplex *sigma, doublecomplex *workev, char *bmat, integer *n, char *which, integer *nev, doublereal *tol, doublecomplex *resid, integer *ncv, doublecomplex *v, integer *ldv, integer *iparam, integer *ipntr, doublecomplex *workd, doublecomplex *workl, integer *lworkl, doublereal *rwork, integer *info, ftnlen howmny_len, ftnlen bmat_len, ftnlen which_len)
{
    ...
    *info = 0;
    ...
    if (*rvec)
    {
        ...
        zlaset_("All", ncv, ncv, &c_b2, &c_b1, &workl[invsub], &ldq, (ftnlen)3);
        ...
        zlacpy_("All", n, &nconv, &v[v_offset], ldv, &z__[z_offset], ldz, (ftnlen)3);
        ...
        if (*(unsigned char *)howmny == 'A')
        {
            ...
            ztrevc_("Right", "Select", &select[1], ncv, &workl[iuptri], &ldq, vl, &c__1, &workl[invsub], &ldq, ncv, &outncv, &workev[1], &rwork[1], &ierr, (ftnlen)5, (ftnlen)6);
            ...
            for (j = 1; j <= i__1; ++j)
            {
                ...
                i__2 = j;
                zzdotc_(&z__1, &j, &workl[ihbds], &c__1, &workl[invsub + (j - 1) * ldq], &c__1);
            ...
            ztrmm_("Right", "Upper", "No transpose", "Non-unit", n, &nconv, &c_b1, &workl[invsub], &ldq, &z__[z_offset], ldz, (ftnlen)5, (ftnlen)5, (ftnlen)12, (ftnlen)8);
        }
    }
    else
    {
    ...
    {
        zvout_(&debug_1.logfil, &nconv, &d__[1], &debug_1.ndigit,
               "_neupd: U"
    ...
    if (*rvec && *(unsigned char *)howmny == 'A' && s_cmp(type__, "SHIFTI", (ftnlen)6, (ftnlen)6) == 0)
    {
        ...
        zgeru_(n, &nconv, &c_b1, &resid[1], &c__1, &workev[1], &c__1, &z__[z_offset], ldz);
    }
