/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\cneigh.f -- translated by f2c (version 20230428).
...
int cneigh_(real *rnorm, integer *n, complex *h__, integer *ldh, complex *ritz, complex *bounds, complex *q, integer *ldq, complex *workl, real *rwork, integer *ierr)
{
    ...
    if (msglvl > 2)
    {
        cmout_(&debug_1.logfil, n, n, &h__[h_offset], ldh, &debug_1.ndigit, "_neigh: Entering upper Hessenberg matrix H ", (ftnlen)43);
    }
