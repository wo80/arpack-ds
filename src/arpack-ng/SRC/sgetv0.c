/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\sgetv0.f -- translated by f2c (version 20230428).
...
int sgetv0_(integer *ido, char *bmat, integer *itry, logical *initv, integer *n, integer *j, real *v, integer *ldv, real *resid, real *rnorm, integer *ipntr, real *workd, integer *ierr, ftnlen bmat_len)
{
    /* Initialized data */
    ...
    extern int scopy_(integer *, real *, integer *, real *, integer *), svout_(integer *, integer *, real *, integer *, char *, ftnlen);
    static real rnorm0;
...
L30:
    ...
    i__1 = *j - 1;
    sgemv_("T", n, &i__1, &c_b26, &v[v_offset], ldv, &workd[1], &c__1, &c_b28, &workd[*n + 1], &c__1, (ftnlen)1);
    i__1 = *j - 1;
    sgemv_("N", n, &i__1, &c_b31, &v[v_offset], ldv, &workd[*n + 1], &c__1, &c_b26, &resid[1], &c__1, (ftnlen)1);
