/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\cneupd.f -- translated by f2c (version 20230428).
	...
	bmat_len, ftnlen which_len)
{
    ...
    extern /* Complex */ VOID ccdotc_(complex *, integer *, complex *, 
...
/*                 %------------------------------------------% */
		...
		i__2 = j;
		ccdotc_(&q__1, &j, &workl[ihbds], &c__1, &workl[invsub + (j - 
			1) * ldq], &c__1);
