/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\dneupd.f -- translated by f2c (version 20230428).
    ...
    *info = 0;
    ...
    if (*rvec)
    {
        ...
        if (msglvl > 1)
        {
            ...
            if (msglvl > 3)
            {
                dmout_(&debug_1.logfil, ncv, ncv, &workl[iuptri], &ldh, &debug_1.ndigit,
        ...
        if (reord)
        {
            ...
            if (msglvl > 2)
            {
                ...
                if (msglvl > 3)
                {
                    dmout_(&debug_1.logfil, ncv, ncv, &workl[iuptri], &ldq, &debug_1.ndigit,
        ...
        if (*(unsigned char *)howmny == 'A')
        {
            ...
            if (msglvl > 2)
            {
                ...
                if (msglvl > 3)
                {
                    dmout_(&debug_1.logfil, ncv, ncv, &workl[invsub], &ldq, &debug_1.ndigit,
