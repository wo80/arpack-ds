/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\ssaup2.f -- translated by f2c (version 20230428).
...
int ssaup2_(integer *ido, char *bmat, integer *n, char *which, integer *nev, integer *np, real *tol, real *resid, integer *mode, integer *iupd, integer *ishift, integer *mxiter, real *v, integer *ldv, real *h__, integer *ldh, real *ritz, real *bounds, real *q, integer *ldq, real *workl, integer *ipntr, real *workd, integer *info, ftnlen bmat_len, ftnlen which_len)
{
    ...
    static real rnorm;
    extern int scopy_(integer *, real *, integer *, real *, integer *), sswap_(integer *, real *, integer *, real *, integer *), ivout_(integer *, integer *, integer *, integer *, char *, ftnlen), svout_(integer *, integer *, real *, integer *, char *, ftnlen), sgetv0_(integer *, char *, integer *, logical *, integer *, integer *, real *, integer *, real *, real *, integer *, real *, integer *, ftnlen);
    integer nevbef;
    ...
    integer nptemp;
    extern int ssaitr_(integer *, char *, integer *, integer *, integer *, integer *, real *, real *, real *, integer *, real *, integer *, integer *, real *, integer *, ftnlen), ssconv_(integer *, real *, real *, real *, integer *), sseigt_(real *, integer *, real *, integer *, real *, real *, real *, integer *), ssgets_(integer *, char *, integer *, integer *, real *, real *, real *, ftnlen), ssapps_(integer *, integer *, integer *, real *, real *, integer *, real *, integer *, real *, real *, integer *, real *), ssortr_(char *, logical *, integer *, real *, real *, ftnlen);
    ...
    ssaitr_(ido, bmat, n, &c__0, &nev0, mode, &resid[1], &rnorm, &v[v_offset], ldv, &h__[h_offset], ldh, &ipntr[1], &workd[1], info, (ftnlen)1);
...
L20:
    ...
    *nev = nev0;
    *np = np0;
    ssgets_(ishift, which, nev, np, &ritz[1], &bounds[1], &workl[1], (ftnlen)2);
    ...
    if (msglvl > 2)
    {
        ...
        ivout_(&debug_1.logfil, &c__3, kp, &debug_1.ndigit,
               ...
               ", NCONV are",
               (ftnlen)26);
        svout_(&debug_1.logfil, &kplusp, &ritz[1], &debug_1.ndigit,
               "_saup2:"
    ...
    if (nconv >= nev0 || iter > *mxiter || *np == 0)
    {
        ...
        if (msglvl > 1)
        {
            svout_(&debug_1.logfil, &kplusp, &ritz[1], &debug_1.ndigit,
                   ...
                   (ftnlen)27);
            svout_(&debug_1.logfil, &kplusp, &bounds[1], &debug_1.ndigit, "_saup2: Sorted ritz estimates.", (ftnlen)30);
        }
    ...
    if (msglvl > 0)
    {
        ...
        if (msglvl > 1)
        {
            ...
            ivout_(&debug_1.logfil, &c__2, kp, &debug_1.ndigit,
                   ...
                   " and NP are",
                   (ftnlen)22);
            svout_(&debug_1.logfil, nev, &ritz[*np + 1], &debug_1.ndigit, "_saup2: \"wanted\" Ritz values.", (ftnlen)29);
            svout_(&debug_1.logfil, nev, &bounds[*np + 1], &debug_1.ndigit, "_saup2: Ritz estimates of the \"wanted\" values ", (ftnlen)46);
        }
    }
...
L50:
    ...
    if (msglvl > 2)
    {
        ivout_(&debug_1.logfil, &c__1, np, &debug_1.ndigit,
               ...
               (ftnlen)38);
        svout_(&debug_1.logfil, np, &workl[1], &debug_1.ndigit,
               "_saup2: shi"
               "fts selected",
               (ftnlen)23);
        if (*ishift == 1)
        {
            svout_(&debug_1.logfil, np, &bounds[1], &debug_1.ndigit,
                   "_saup2"
