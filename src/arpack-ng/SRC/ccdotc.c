...
/* Complex */ VOID ccdotc_(complex * ret_val, integer *n, complex *zx, 
	integer *incx, complex *zy, integer *incy)
{
...
/*          not equal to 1 */
	...
	r_cnjg(&q__3, &zx[ix]);
	i__2 = iy;
	q__2.r = q__3.r * zy[i__2].r - q__3.i * zy[i__2].i, q__2.i = q__3.r * 
		zy[i__2].i + q__3.i * zy[i__2].r;
