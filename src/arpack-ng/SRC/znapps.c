/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\znapps.f -- translated by f2c (version 20230428).
...
int znapps_(integer *n, integer *kev, integer *np, doublecomplex *shift, doublecomplex *v, integer *ldv, doublecomplex *h__, integer *ldh, doublecomplex *resid, doublecomplex *q, integer *ldq, doublecomplex *workl, doublecomplex *workd)
{
    /* Initialized data */
    ...
    doublecomplex sigma;
    extern int zscal_(integer *, doublecomplex *, doublecomplex *, integer *), zgemv_(char *, integer *, integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, integer *, doublecomplex *, doublecomplex *, integer *, ftnlen), zcopy_(integer *, doublecomplex *, integer *, doublecomplex *, integer *), ivout_(integer *, integer *, integer *, integer *, char *, ftnlen), zaxpy_(integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, integer *), zmout_(integer *, integer *, integer *, doublecomplex *, integer *, integer *, char *, ftnlen),
    ...
    extern int zlacpy_(char *, integer *, integer *, doublecomplex *, integer *, doublecomplex *, integer *, ftnlen), zlartg_(doublecomplex *, doublecomplex *, doublereal *, doublecomplex *, doublecomplex *), zlaset_(char *, integer *, integer *, doublecomplex *, doublecomplex *, doublecomplex *, integer *, ftnlen);
    ...
    L20:
        ...
        for (i__ = istart; i__ <= i__2; ++i__)
        {
            ...
            tst1 = (d__1 = h__[i__3].r, abs(d__1)) + (d__2 = d_imag(&h__[i__ + i__ * h_dim1]), abs(d__2)) + ((d__3 = h__[i__4].r, abs(d__3)) + (d__4 = d_imag(&h__[i__ + 1 + (i__ + 1) * h_dim1]), abs(d__4)));
            if (tst1 == 0.)
            {
                i__3 = kplusp - jj + 1;
                tst1 = zlanhs_("1", &i__3, &h__[h_offset], ldh, &workl[1], (ftnlen)1);
            }
    ...
    L40:
        ...
        for (i__ = istart; i__ <= i__2; ++i__)
        {
            ...
            for (j = i__; j <= i__3; ++j)
            {
                ...
                i__5 = i__ + 1 + j * h_dim1;
                z__3.r = s.r * h__[i__5].r - s.i * h__[i__5].i, z__3.i = s.r * h__[i__5].i + s.i * h__[i__5].r;
                ...
                i__5 = i__ + j * h_dim1;
                z__2.r = z__3.r * h__[i__5].r - z__3.i * h__[i__5].i, z__2.i = z__3.r * h__[i__5].i + z__3.i * h__[i__5].r;
                i__6 = i__ + 1 + j * h_dim1;
            ...
            for (j = 1; j <= i__3; ++j)
            {
                ...
                d_cnjg(&z__4, &s);
                i__5 = j + (i__ + 1) * h_dim1;
                z__3.r = z__4.r * h__[i__5].r - z__4.i * h__[i__5].i, z__3.i = z__4.r * h__[i__5].i + z__4.i * h__[i__5].r;
                z__1.r = z__2.r + z__3.r, z__1.i = z__2.i + z__3.i;
                t.r = z__1.r, t.i = z__1.i;
                i__4 = j + (i__ + 1) * h_dim1;
    ...
    for (i__ = 1; i__ <= i__1; ++i__)
    {
        ...
        i__2 = i__ + i__ * h_dim1;
        i__3 = i__ + 1 + (i__ + 1) * h_dim1;
        tst1 = (d__1 = h__[i__2].r, abs(d__1)) + (d__2 = d_imag(&h__[i__ + i__ * h_dim1]), abs(d__2)) + ((d__3 = h__[i__3].r, abs(d__3)) + (d__4 = d_imag(&h__[i__ + 1 + (i__ + 1) * h_dim1]), abs(d__4)));
        if (tst1 == 0.)
        {
            tst1 = zlanhs_("1", kev, &h__[h_offset], ldh, &workl[1], (ftnlen)1);
        }
    ...
    if (msglvl > 1)
    {
        ...
        if (msglvl > 2)
        {
            zmout_(&debug_1.logfil, kev, kev, &h__[h_offset], ldh, &debug_1.ndigit,
