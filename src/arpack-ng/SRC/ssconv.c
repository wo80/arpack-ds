/* D:\projects\Fortran\arpack-ng-3.9.1-patched\SRC\ssconv.f -- translated by f2c (version 20230428).
...
int ssconv_(integer *n, real *ritz, real *bounds, real *tol, integer *nconv)
{
