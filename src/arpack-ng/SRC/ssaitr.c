/* SRC\ssaitr.f -- translated by f2c (version 20230428). */
...
static float c_b24 = 1.f;
static float c_b49 = 0.f;
static float c_b57 = -1.f;
static a_int c__2 = 2;
...
int ssaitr_(a_int *ido, char *bmat, a_int *n, a_int *k, a_int *np, a_int *mode, float *resid, float *rnorm, float *v, a_int *ldv, float *h__, a_int *ldh, a_int *ipntr, float *workd, a_int *info, ftnlen bmat_len)
{
    /* Initialized data */
    ...
    a_int jj;
    static a_int ipj, irj, ivj, ierr, iter;
    ...
    static float wnorm;
    extern int ivout_(a_int *, a_int *, a_int *, a_int *, char *, ftnlen), svout_(a_int *, a_int *, float *, a_int *, char *, ftnlen), sgetv0_(a_int *, char *, a_int *, a_bool *, a_int *, a_int *, float *, a_int *, float *, float *, a_int *, float *, a_int *, ftnlen);
    static float rnorm1;
...
L40:
    ...
    else
    {
        ...
        slascl_("General", &i__, &i__, rnorm, &c_b24, n, &c__1, &v[j * v_dim1 + 1], n, &infol, (ftnlen)7);
        slascl_("General", &i__, &i__, rnorm, &c_b24, n, &c__1, &workd[ipj], n, &infol, (ftnlen)7);
    }
...
L65:
    ...
    if (*mode != 2)
    {
        sgemv_("T", n, &j, &c_b24, &v[v_offset], ldv, &workd[ipj], &c__1, &c_b49, &workd[irj], &c__1, (ftnlen)1);
    }
    else if (*mode == 2)
    {
        sgemv_("T", n, &j, &c_b24, &v[v_offset], ldv, &workd[ivj], &c__1, &c_b49, &workd[irj], &c__1, (ftnlen)1);
    }
    ...
    sgemv_("N", n, &j, &c_b57, &v[v_offset], ldv, &workd[irj], &c__1, &c_b24, &resid[1], &c__1, (ftnlen)1);
...
L100:
    ...
    if (j > *k + *np)
    {
        ...
        *ido = 99;
        ...
        {
            i__1 = *k + *np;
            svout_(&debug_1.logfil, &i__1, &h__[(h_dim1 << 1) + 1], &debug_1.ndigit,
